...
def search_conversations(
    ...
    distance = models.Conversation.embedding.cosine_distance(query_embedding).label(
        "distance"
    )
    conversations = (
        db.query(models.Conversation, distance)
...
def complete_onboarding(
    ...
    transcript = [
        {"role": msg.role, "content": decrypt_data(msg.content)} for msg in messages
    ]
